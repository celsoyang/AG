...
public class StringsUtils {
    ...
    public static String SELECT_FUNCIONARIO_TESTE = "select fu from Funcionario fu order by fu.area, fu.cargo";

    public static String SELECT_ATIVIDADE_TESTE = "select atv from Atividade atv order by atv.area";
